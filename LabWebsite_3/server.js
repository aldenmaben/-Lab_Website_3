...
app.get('/team_stats', function(req, res){
  var games = 'SELECT * FROM football_games;';
	var lose = 'SELECT COUNT(*) FROM football_games WHERE visitor_score > home_score;';
...
/*********************************
  		...
  		/team_stats - get request (no parameters)
  			...
  			and show the total number of win/lose for the season.
